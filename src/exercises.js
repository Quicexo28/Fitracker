                ...
                variations: [
                    { id: 'cr-extended-knee', name: 'con Rodilla Extendida',
                        subVariations: [
                            ...
                            { id: 'cr-extended-knee-press-uni', name: 'en Prensa unilateral', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla', isUnilateral: true },
                            { id: 'cr-extended-knee-smith', name: 'en Smith', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla' },
                            { id: 'cr-extended-knee-smith-uni', name: 'en Smith unilateral', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla', isUnilateral: true },
                            { id: 'cr-extended-knee-hack', name: 'en Hack', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla' },
                            { id: 'cr-extended-knee-hack-uni', name: 'en Hack unilateral', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla', isUnilateral: true },
                            { id: 'cr-extended-knee-bodyweight', name: 'con Peso Corporal', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla' },
                            { id: 'cr-extended-knee-bodyweight-uni', name: 'con Peso Corporal unilateral', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla', isUnilateral: true },
                            { id: 'cr-extended-knee-barbell', name: 'con Barra', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla' },
                            { id: 'cr-extended-knee-barbell-uni', name: 'con Barra unilateral', imageUrl: 'https://placehold.co/100x100/ca8a04/ffffff?text=Pantorrilla', isUnilateral: true },
                        ]
                     },
